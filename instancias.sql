INSERT INTO genres (id, slug, label, description)
VALUES
...
INSERT INTO authors (id, name, picture_url, birth_place, birth_date, death_date, website, biography)
VALUES
...
INSERT INTO works (id, title, first_publication_date, mean_rating)
VALUES
...
INSERT INTO editions (id, title, page_count, format, publication_date, publisher, language, cover_image_url, summary, isbn, asin, work_id)
VALUES
...
INSERT INTO users (id, email, password, first_name, last_name, picture_url)
VALUES
...
INSERT INTO groups (id, name, description, picture_url)
VALUES
...
INSERT INTO quotes (id, quote, author_id)
VALUES
...
INSERT INTO positionings (series_id, work_id, position)
VALUES
	(1, 2, 1),
	(1, 3, 2),
	(1, 4, 3),
...
INSERT INTO categorizations (work_id, genre_id)
VALUES
...
INSERT INTO storages (edition_id, shelf_id)
VALUES
	...
	(11, 3), -- Fundação nos lidos 2023
	(12, 3), -- Fundação e Império nos lidos 2023
	(13, 4); -- Segunda Fundação nos lidos 2024

INSERT INTO ownerships (shelf_id, user_id)
VALUES
	(1, 1), -- João possui estante favoritos
	(2, 1), -- João possui estante para-ler
	(3, 2), -- Maria possui estante lidos-2023
	(4, 2), -- Maria possui estante lidos-2024
	...
	(3, 7), -- Roberto possui estante lidos-2023
	(4, 8); -- Julia possui estante lidos-2024

INSERT INTO trackings (edition_id, user_id, status, progress, rating, review, reading_period) VALUES
	-- João Silva - leu livros de todos os gêneros (para consulta 2)
	(1, 1, 'read', 100, 5, 'Excelente livro!', '[2023-01-15,2023-02-15)'),
	(9, 1, 'read', 100, 4, 'Clássico atemporal', '[2023-03-01,2023-04-01)'),
	(11, 1, 'read', 100, 5, 'Obra-prima da ficção científica', '[2023-05-01,2023-06-01)'),
	(8, 1, 'read', 100, 4, 'Mistério envolvente', '[2023-07-01,2023-08-01)'),
	(10, 1, 'read', 100, 4, 'Romance clássico', '[2023-09-01,2023-10-01)'),

	-- Maria Santos - leu muitos livros em 2023 (para consulta 6)
	(1, 2, 'read', 100, 5, 'Adorei!', '[2023-01-01,2023-01-31)'),
	(2, 2, 'read', 100, 5, 'Fantástico!', '[2023-02-01,2023-03-15)'),
	(3, 2, 'read', 100, 4, 'Muito bom', '[2023-04-01,2023-05-15)'),
	(4, 2, 'read', 100, 5, 'Perfeito!', '[2023-06-01,2023-07-15)'),
	(5, 2, 'read', 100, 4, 'Interessante', '[2023-08-01,2023-09-15)'),
	(6, 2, 'read', 100, 4, 'Bom desenvolvimento', '[2023-10-01,2023-11-15)'),
	(7, 2, 'read', 100, 5, 'Excelente!', '[2023-12-01,2023-12-31)'),
	(8, 2, 'read', 100, 4, 'Mistério bem construído', '[2023-01-15,2023-02-15)'),
	(9, 2, 'read', 100, 4, 'Clássico', '[2023-03-01,2023-04-01)'),
	(10, 2, 'read', 100, 5, 'Genial!', '[2023-05-01,2023-06-01)'),
	(11, 2, 'read', 100, 4, 'Continuação boa', '[2023-07-01,2023-08-01)'),
	(12, 2, 'read', 100, 5, 'Final perfeito', '[2023-09-01,2023-10-01)'),
	(13, 2, 'read', 100, 4, 'Satisfatório', '[2023-11-01,2023-12-01)'),

	-- Pedro Oliveira - leu livros de fantasia (para consulta 7)
	(1, 3, 'read', 100, 5, 'Obra-prima', '[2023-01-01,2023-02-01)'),
	(2, 3, 'read', 100, 5, 'Fantástico!', '[2023-03-01,2023-04-15)'),
	(3, 3, 'read', 100, 5, 'Excelente continuação', '[2023-05-01,2023-06-15)'),
	(4, 3, 'read', 100, 5, 'Final perfeito', '[2023-07-01,2023-08-15)'),
	(5, 3, 'read', 100, 4, 'Muito bom', '[2023-09-01,2023-10-15)'),
	(6, 3, 'read', 100, 4, 'Boa continuação', '[2023-11-01,2023-12-15)'),
	(7, 3, 'read', 100, 5, 'Melhor da série', '[2024-01-01,2024-02-15)'),

	-- Ana Costa - leu livros de ficção científica (para consulta 7)
	(10, 4, 'read', 100, 5, 'Revolucionário', '[2023-01-01,2023-02-01)'),
	(11, 4, 'read', 100, 5, 'Excelente continuação', '[2023-03-01,2023-04-01)'),
	(12, 4, 'read', 100, 5, 'Final brilhante', '[2023-05-01,2023-06-01)'),
	(13, 4, 'read', 100, 4, 'Muito bom', '[2023-07-01,2023-08-01)'),

	-- Carlos Rodrigues - leu livros de mistério (para consulta 7)
	(8, 5, 'read', 100, 4, 'Mistério envolvente', '[2023-01-01,2023-02-01)'),
	(9, 5, 'read', 100, 4, 'Clássico', '[2023-03-01,2023-04-01)'),

	-- Lúcia Ferreira - leu livros de romance (para consulta 7)
	(9, 6, 'read', 100, 5, 'Romance perfeito', '[2023-01-01,2023-02-01)'),
	(10, 6, 'read', 100, 4, 'Interessante', '[2023-03-01,2023-04-01)'),

	-- Roberto Almeida - leu livros de não-ficção (para consulta 7)
	(11, 7, 'read', 100, 4, 'Informativo', '[2023-01-01,2023-02-01)'),
	(12, 7, 'read', 100, 4, 'Bom conteúdo', '[2023-03-01,2023-04-01)'),

	-- Julia Martins - leu livros de fantasia (para consulta 7)
	(1, 8, 'read', 100, 5, 'Adorei!', '[2023-01-01,2023-02-01)'),
	(2, 8, 'read', 100, 5, 'Fantástico!', '[2023-03-01,2023-04-01)'),
	(3, 8, 'read', 100, 5, 'Excelente!', '[2023-05-01,2023-06-01)'),

	-- Leituras atuais (para consulta 8)
	(4, 1, 'currently-reading', 50, NULL, NULL, '[2024-01-01,)'),
	(5, 2, 'currently-reading', 75, NULL, NULL, '[2024-01-15,)'),
	(6, 3, 'currently-reading', 25, NULL, NULL, '[2024-02-01,)'),

	-- Leituras recentes (para consulta 8)
	(7, 4, 'read', 100, 5, 'Excelente!', '[2024-01-01,2024-01-31)'),
	(8, 5, 'read', 100, 4, 'Bom mistério', '[2024-01-15,2024-02-15)'),
	(9, 6, 'read', 100, 4, 'Clássico', '[2024-02-01,2024-03-01)');

INSERT INTO likes (quote_id, user_id)
VALUES
...
INSERT INTO moderations (user_id, group_id)
VALUES
	(1, 1), -- João modera Clube de Fantasia
	(4, 2), -- Ana modera Clube de Mistério
	(7, 3); -- Roberto modera Clube de Sci-Fi

INSERT INTO currently_readings (edition_id, group_id, start_date, finish_date)
VALUES
	(1, 1, '2024-01-01', NULL), -- Clube de Fantasia lendo O Hobbit
	(8, 2, '2024-01-15', NULL), -- Clube de Mistério lendo Assassinato no Expresso do Oriente
	(10, 3, '2024-02-01', NULL); -- Clube de Sci-Fi lendo Fundação

INSERT INTO list_entries (id, vote_count, list_id, edition_id)
VALUES
...
INSERT INTO votes (user_id, list_entry_id)
VALUES
