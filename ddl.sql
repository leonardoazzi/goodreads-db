...
---------------------------------------------------------------
-- Drop all tables and types in reverse order of creation to avoid dependency issues

DROP TABLE IF EXISTS votes CASCADE;
DROP TABLE IF EXISTS currently_readings CASCADE;
...
DROP TABLE IF EXISTS positionings CASCADE;
